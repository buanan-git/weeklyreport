...
MY_ID = 's673090'
STAFF_IDS = [
    's673090','s801573', 's733504', 's682083', 's929270', 's798268','s811385', 's865585', 's783729', 's400192', 's823700'
]
...
def generate_team_weekly_v10(reports):
    ...
    for staff_id in STAFF_IDS:
        # 跳过MY_ID（如果已经在STAFF_IDS中，但我们已经处理过）
        if staff_id == MY_ID:
            continue
    ...
    team_report = {
        ...
        'content': {
            ...
            'part2_okr_structure': optimized_okr_structure,
